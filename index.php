                            ...
                            <li id="lnLi_0" class="bx-shodow-black mt-7 pb-10 bg-info">
                                <div id="lnDiv_0" class="option-group field">
                                    <label id="lnLabel_0" class="flo-option block">
                                        ...
                                        <i class="fas fa-pencil-alt fa-lg i-spec d-none"></i>
                                        <i class="fas fa-eye fa-lg i-spec"></i>
                                        <i class="fas fa-cart-plus fa-lg i-spec"></i>
                                        <i class="fas fa-trash fa-lg text-danger i-spec"></i>
                                    </label>
